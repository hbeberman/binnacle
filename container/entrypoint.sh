...
# NOTE: --write-agents-md is NOT passed here - AGENTS.md should be managed by
# the host repo maintainer, not auto-generated by container agents.
echo "📝 Initializing binnacle configuration..."
if ! bn system host-init --write-claude-skills --write-mcp-copilot -y > /dev/null 2>&1; then
