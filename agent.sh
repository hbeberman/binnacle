...
TOOLS_FULL='--allow-tool "write" --allow-tool "shell(bn:*)" --allow-tool "shell(./target/release/bn)" --allow-tool "shell(cargo run)" --allow-tool "shell(cargo fmt)" --allow-tool "shell(cargo clippy)" --allow-tool "shell(cargo test)" --allow-tool "shell(cargo build)" --allow-tool "shell(cargo audit)" --allow-tool "shell(sleep)" --allow-tool "shell(wait)" --allow-tool "shell(git add)" --allow-tool "shell(git commit)" --allow-tool "shell(git:*)" --allow-tool "shell(just check)"'

TOOLS_PRD='--allow-tool "write" --allow-tool "shell(bn:*)" --allow-tool "shell(./target/release/bn)" --allow-tool "shell(git add)" --allow-tool "shell(git commit)" --allow-tool "shell(git:*)"'

TOOLS_BUDDY='--allow-tool "shell(bn:*)" --allow-tool "shell(./target/release/bn)" --allow-tool "shell(git add)" --allow-tool "shell(git commit)" --allow-tool "shell(git:*)"'
